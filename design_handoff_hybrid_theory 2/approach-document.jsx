/* eslint-disable */
// Approach section — Variant A "Document metaphor".
// Project as a one-page paper brief · Retainer as an ongoing Slack channel.

function ApproachDocument() {
  return (
          ...
          <article className="doc-chan">
            ...
            <div className="doc-chan-section">
              <div className="doc-chan-thread">
                {[
                  { who: "Devon",     init: "D", time: "today 9:14a", txt: "Quick one — photo-to-quote chokes on HEIC files >5MB.", client: true },
                  { who: "HT · Mara", init: "M", time: "today 9:22a", txt: "Looking. Likely a conversion step. Fix by EOD?",        ht: true },
                  { who: "Devon",     init: "D", time: "today 9:23a", txt: "Perfect, thanks.",                                      client: true },
...
Object.assign(window, { ApproachDocument });
