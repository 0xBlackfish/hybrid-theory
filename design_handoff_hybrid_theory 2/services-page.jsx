...
// 3 services: Automation & Custom Tools, AI Strategy, Team Training
// Each as a deep section with hero, bullets, what-an-engagement-looks-like aside.
...
const SERVICES_PAGE = [
  {
    ...
    title: <>We find the work eating your week, and <span className="italic" style={{ color: "var(--lime)" }}>build the thing</span> that does it for you.</>,
...
Object.assign(window, { ServicesPageApp });
