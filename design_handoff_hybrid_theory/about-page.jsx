...
// No faces, no team photos — just the firm's story, principles, and credentials.
        ...
        <section className="about-section">
          <div className="wrap">
            <div className="about-grid">
              ...
              <p>Hybrid Theory is a small team of senior engineers, designers, and data scientists. We've shipped products to millions of users at companies you've heard of.

              </p>
              <p>We work with businesses that typically have less access to technical resources — auto shops, regional manufacturers, dental groups, small agencies. The places where one shipped tool can shift a whole week of work.

              </p>
              <p>We're here because AI changed what a single engineer can do. That leverage should land where the work actually serves people. The businesses that need it most have been the last to get it and we thought that should change.

              </p>
              <p className="muted">We don't sell AI. We sell the outcomes that AI makes possible.
...
Object.assign(window, { AboutPageApp });